...
#' @usage ppgm(occurrences, fossils, tree, fossils.edges, model = "BM", permut=1, only.biovars=TRUE, which.biovars = c(1,12), path = "", plotTraitGram = F, plot.AnimatedMaps = F, plot.GeoRates = F, plot.BumpChart = F, bounds = list(), control = list(), use.paleoclimate = TRUE, verbose = TRUE)
